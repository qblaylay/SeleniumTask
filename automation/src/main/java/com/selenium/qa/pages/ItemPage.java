...
public class ItemPage {
    ...
    @FindBy(id = "WLNEW_list_type_WL")
    static WebElement listTypeRadioButton;
    @FindBy(className = "a-button-input a-declarative")
    static WebElement createListButton;
    ...
    public void selectListTypeButton() {

        listTypeRadioButton.click();
    }
